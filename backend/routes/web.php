...
Route::group(['prefix' => 'forum', 'namespace' => 'Forum'], function ($router) {
    ...
    Route::get('/', [\App\Http\Controllers\Forum\ForumController::class, 'index'])->name('forums_list');
    Route::get('/{forum_id}', [\App\Http\Controllers\Forum\TopicController::class, 'index'])->name('forum_topics_list');
